...
const Hero = () => {
  return (
    <div className='flex flex-col items-center mt-6 lg:mt-8'>
        ...
        text-center tracking-wide'>VirtualR build tools 
        <span className='bg-gradient-to-r from-orange-500 
        to-orange-800 text-transparent bg-clip-text'> for developers</span></h1>
        ...
        <div className='flex mt-6 justify-center'>
          ...
          w-1/2 border border-orange-700 shadow-orange-400 m-4'>
